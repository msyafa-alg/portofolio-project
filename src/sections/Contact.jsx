...
const socials = [
  { icon: <FiMail size={15} />,     label: 'firdaussyafa12@email.com',       href: 'firdaussyafa12@email.com' },
  { icon: <FiLinkedin size={15} />, label: 'Syafa Algiffari',  href: 'https://www.linkedin.com/in/syafa-algiffari-567a48375/' },
  { icon: <FiGithub size={15} />,   label: 'msyafa-alg',       href: 'https://github.com/msyafa-alg' },
]
            ...
            {['name', 'email'].map(field => (
              <div key={field}>
                ...
                <input type={field === 'email' ? 'email' : 'text'} name={field} value={form[field]}
                  onChange={handleChange} placeholder={field === 'email' ? 'your@email.com' : 'Your name'}
