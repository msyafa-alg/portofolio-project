            ...
            <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid grid-cols-2 gap-3">
              {hardSkills.map(({ icon, label }) => (
                <motion.div key={label} variants={cardAnim}
                  ...
                  className="flex items-center gap-3 bg-zinc-950/60 border border-zinc-800 rounded-xl px-4 py-3 cursor-default hover:border-cyan-400/30 transition-colors">
